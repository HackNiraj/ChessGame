...
public class PawnPromotionPanel extends JDialog{
    ...
    public Piece getPromotedPiece(final int piecePosition, final Alliance pieceAlliance){
        switch(pieceName){
            case "Queen": return new Queen(piecePosition,pieceAlliance,false);
            case "Bishop": return new Bishop(piecePosition,pieceAlliance,false);
            case "Knight": return new Knight(piecePosition,pieceAlliance,false);
            case "Rook": return new Rook(piecePosition,pieceAlliance,false);
        }
